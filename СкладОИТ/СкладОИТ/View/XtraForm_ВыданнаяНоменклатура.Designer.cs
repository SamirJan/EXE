...
{
    partial class XtraForm_ВыданнаяНоменклатура
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.xpCollection_ВыданнаяНоменклатура = new DevExpress.Xpo.XPCollection(this.components);
            ...
            this.repositoryItemLookUpEdit_СерияНомер = new DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.xpCollection_ВыданнаяНоменклатура)).BeginInit();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.repositoryItemLookUpEdit_СерияНомер)).BeginInit();
            ...
            // gridControl1
            // 
            this.gridControl1.DataSource = this.xpCollection_ВыданнаяНоменклатура;
            ...
            this.repositoryItemLookUpEdit_СерияНомер});
            this.gridControl1.Size = new System.Drawing.Size(950, 313);
            ...
            this.gridView1});
            // 
            // xpCollection_ВыданнаяНоменклатура
            // 
            this.xpCollection_ВыданнаяНоменклатура.DeleteObjectOnRemove = true;
            this.xpCollection_ВыданнаяНоменклатура.ObjectType = typeof(СкладОИТ.XPO.СкладОИТ.ВыданнаяНоменклатура);
            this.xpCollection_ВыданнаяНоменклатура.ResolveSession += new DevExpress.Xpo.ResolveSessionEventHandler(this.XpCollection_ВыданнаяНоменклатура_ResolveSession);
            // 
            // gridView1
            // 
            ...
            this.xpCollection_Номенклатура.ObjectType = typeof(СкладОИТ.XPO.СкладОИТ.Номенклатура);
            this.xpCollection_Номенклатура.ResolveSession += new DevExpress.Xpo.ResolveSessionEventHandler(this.XpCollection_ВыданнаяНоменклатура_ResolveSession);
            // 
            // colСерияНомер
            // 
            this.colСерияНомер.Caption = "Серия Номер";
            this.colСерияНомер.ColumnEdit = this.repositoryItemLookUpEdit_СерияНомер;
            this.colСерияНомер.FieldName = "НоменклатураID!Key";
            ...
            // 
            // repositoryItemLookUpEdit_СерияНомер
            // 
            this.repositoryItemLookUpEdit_СерияНомер.AutoHeight = false;
            this.repositoryItemLookUpEdit_СерияНомер.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
            this.repositoryItemLookUpEdit_СерияНомер.Columns.AddRange(new DevExpress.XtraEditors.Controls.LookUpColumnInfo[] {
            new DevExpress.XtraEditors.Controls.LookUpColumnInfo("Серияномер", "Серияномер", 71, DevExpress.Utils.FormatType.None, "", true, DevExpress.Utils.HorzAlignment.Near, DevExpress.Data.ColumnSortOrder.None, DevExpress.Utils.DefaultBoolean.Default)});
            this.repositoryItemLookUpEdit_СерияНомер.DataSource = this.xpCollection_Номенклатура;
            this.repositoryItemLookUpEdit_СерияНомер.DisplayMember = "Серияномер";
            this.repositoryItemLookUpEdit_СерияНомер.Name = "repositoryItemLookUpEdit_СерияНомер";
            this.repositoryItemLookUpEdit_СерияНомер.NullText = "";
            this.repositoryItemLookUpEdit_СерияНомер.PopupFilterMode = DevExpress.XtraEditors.PopupFilterMode.Contains;
            this.repositoryItemLookUpEdit_СерияНомер.TextEditStyle = DevExpress.XtraEditors.Controls.TextEditStyles.Standard;
            this.repositoryItemLookUpEdit_СерияНомер.ValueMember = "Oid";
            // 
            // colКоличество
            // 
            ...
            this.xpCollection_Пользователь.ObjectType = typeof(СкладОИТ.XPO.СкладОИТ.Пользователь);
            this.xpCollection_Пользователь.ResolveSession += new DevExpress.Xpo.ResolveSessionEventHandler(this.XpCollection_ВыданнаяНоменклатура_ResolveSession);
            // 
            // colОтдел
            // 
            ...
            this.xpCollection_Отдел.ObjectType = typeof(СкладОИТ.XPO.СкладОИТ.Отдел);
            this.xpCollection_Отдел.ResolveSession += new DevExpress.Xpo.ResolveSessionEventHandler(this.XpCollection_ВыданнаяНоменклатура_ResolveSession);
            // 
            // colСтатус
            // 
            ...
            this.layoutControlItem1.Size = new System.Drawing.Size(954, 317);
    ...
    "траница (*.html)|*.html";
            ...
            this.Name = "XtraForm_ВыданнаяНоменклатура";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Выданная номенклатура";
            ((System.ComponentModel.ISupportInitialize)(this.layoutControl1)).EndInit();
            this.layoutControl1.ResumeLayout(false);
            ((System.ComponentModel.ISupportInitialize)(this.gridControl1)).EndInit();
            ((System.ComponentModel.ISupportInitialize)(this.xpCollection_ВыданнаяНоменклатура)).EndInit();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.repositoryItemLookUpEdit_СерияНомер)).EndInit();
        ...
        private DevExpress.Xpo.XPCollection xpCollection_ВыданнаяНоменклатура;
        ...
        private DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit repositoryItemLookUpEdit_СерияНомер;
    }
}